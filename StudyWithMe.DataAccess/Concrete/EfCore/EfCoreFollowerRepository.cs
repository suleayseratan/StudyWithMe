...
{
    public class EfCoreFollowerRepository : EfCoreGenericRepository<Follower>, IFollowerRepository
    {
        public EfCoreFollowerRepository(DbContext context) : base(context)
        {
