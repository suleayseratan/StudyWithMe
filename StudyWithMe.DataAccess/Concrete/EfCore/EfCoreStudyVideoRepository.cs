...
{
    public class EfCoreStudyVideoRepository : EfCoreGenericRepository<StudyVideo>, IStudyVideoRepository 
    {
        public EfCoreStudyVideoRepository(DbContext context) : base(context)
        {
